...
#ifndef LOVE_JOYSTICK_ANDROID_JOYSTICK_H
#define LOVE_JOYSTICK_ANDROID_JOYSTICK_H
...
namespace android
{
	...
	private:
		...
		static EnumMap<Hat, uint8_t, Joystick::HAT_MAX_ENUM>::Entry hatEntries[];
		static EnumMap<Hat, uint8_t, Joystick::HAT_MAX_ENUM> hats;
