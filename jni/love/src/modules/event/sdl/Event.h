...
namespace sdl
{
	...
	private:
		...
		bool convert(AndroidEvent & e, Message & m);
		bool convert(Message & m, AndroidEvent & e);
		...
		static EnumMap<love::mouse::Mouse::Button, int, love::mouse::Mouse::BUTTON_MAX_ENUM>::Entry buttonEntries[];
		static EnumMap<love::mouse::Mouse::Button, int, love::mouse::Mouse::BUTTON_MAX_ENUM> buttons;
